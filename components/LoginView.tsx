      ...
      <div className="w-full max-w-md px-6 relative z-10">
        ...
        <div className="text-center mb-10 group">
          <div className="relative inline-flex mb-8">
             ...
             <div className="relative p-6 bg-slate-900 border border-slate-800 rounded-[2rem] shadow-2xl flex items-center justify-center">
          ...
          <h1 className="text-5xl font-black text-white tracking-tighter flex flex-col items-center">
            <span className="bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent">E-MEETING</span>
            <span className="text-sm font-black text-blue-500 uppercase tracking-[0.5em] mt-2 shadow-blue-500/50">SLA PLATFORM</span>
          </h1>
          <p className="text-slate-500 mt-6 text-xs font-bold uppercase tracking-[0.2em] opacity-60">Hệ thống Giám sát & Quản trị Tập trung</p>
        </div>

        {/* Login Card */}
        <div className="bg-[#161B22]/80 backdrop-blur-2xl rounded-[2.5rem] p-10 shadow-2xl border border-white/5 transform transition-all duration-300">
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 text-[9px] font-black uppercase tracking-[0.3em] leading-relaxed">
            HỆ THỐNG GIÁM SÁT SLA CẦU TRUYỀN HÌNH<br/>
